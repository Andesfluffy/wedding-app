  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-24 top-0 h-72 w-72 rounded-full bg-gold/30 blur-3xl sm:h-96 sm:w-96" />
        <div className="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-blush/30 blur-3xl sm:h-[28rem] sm:w-[28rem]" />
        <div className="absolute -bottom-16 left-1/2 h-48 w-48 -translate-x-1/2 rounded-full bg-olive/25 blur-3xl sm:h-64 sm:w-64" />
      </div>
      <div className="mx-auto flex max-w-6xl flex-col items-center rounded-[3rem] border border-white/60 bg-white/80 px-6 pb-16 pt-20 text-center shadow-xl shadow-olive/20 backdrop-blur-lg sm:px-12 md:flex-row md:items-end md:justify-between md:text-left md:pt-28">
        <motion.div
        ...
        <motion.div
          ...
          className="mt-16 w-full max-w-sm rounded-3xl bg-white/85 p-8 text-left shadow-lg shadow-olive/20 backdrop-blur md:mt-0"
        >
