...
export const guestList: GuestInvitation[] = [
  ...
  { id: "bride-50", name: "Nwakego Okoli", maxGuests: 1 },
  { id: "bride-51", name: "Mrs Funmilayo Balogun", maxGuests: 1 },
  { id: "bride-52", name: "Mr Andy and Co Ucss", maxGuests: 4 },
  { id: "bride-53", name: "Sis Edith Osuachala", maxGuests: 1 },
  { id: "bride-54", name: "Olamide", maxGuests: 1 },
  { id: "bride-55", name: "Chiyonce", maxGuests: 1 },
  { id: "bride-56", name: "Michael Ekpeti", maxGuests: 1 },
  { id: "bride-57", name: "Dr Emomotimi Agama", maxGuests: 1 },
  { id: "bride-58", name: "Dr Bayo Olugbemi", maxGuests: 1 },
  { id: "bride-59", name: "Dr Catherine Nwosu", maxGuests: 1 },
  { id: "bride-60", name: "Mrs Shotunde", maxGuests: 1 },
  { id: "bride-61", name: "Isaac Namabiri", maxGuests: 1 },
  { id: "bride-62", name: "Isaiah Omah", maxGuests: 1 },
  { id: "bride-63", name: "Mrs Mubo Olasoko", maxGuests: 1 },
  { id: "bride-64", name: "Dr Peter Ashade", maxGuests: 1 },
  { id: "bride-65", name: "Mr Idiong Obong", maxGuests: 1 },
  { id: "bride-66", name: "Mrs Motunde Dada", maxGuests: 1 },
  { id: "bride-67", name: "Vivian Tarabena", maxGuests: 1 },
  { id: "bride-68", name: "Priscilla Welham", maxGuests: 1 },
  { id: "bride-69", name: "Kelvin Ogaga", maxGuests: 1 },
  { id: "bride-70", name: "Mr and Mrs Edward Ekpeti", maxGuests: 2 },
  { id: "bride-71", name: "Mr Adigheji Omoefe", maxGuests: 1 },

  //groom's guests
  { id: "groom-72", name: "Oyeyemi family", maxGuests: 3 },
  { id: "groom-73", name: "Afolabi family", maxGuests: 3 },
  { id: "groom-74", name: "Sola Oyeyemi and family", maxGuests: 4 },
  { id: "groom-75", name: "Idris Oko-osi and family", maxGuests: 5 },
  { id: "groom-76", name: "Qudus Oko-osi and family", maxGuests: 4 },
  { id: "groom-77", name: "Sodiq Oko-osi and family", maxGuests: 3 },
  { id: "groom-78", name: "Eruwahvwe family", maxGuests: 5 },
  { id: "groom-79", name: "Essien family", maxGuests: 5 },
  { id: "groom-80", name: "Elizabeth", maxGuests: 1 },
  { id: "groom-81", name: "Akinremi family", maxGuests: 4 },
  { id: "groom-82", name: "Ologe family", maxGuests: 4 },
  { id: "groom-83", name: "Aunty's Aina and Wande family", maxGuests: 5 },
  { id: "groom-84", name: "Yaya family", maxGuests: 3 },
  { id: "groom-85", name: "Jumoke, Adiza, Oga", maxGuests: 3 },
  { id: "groom-86", name: "Ugochukwu family", maxGuests: 5 },
  { id: "groom-87", name: "Bewaji family", maxGuests: 6 },
  { id: "groom-88", name: "Iboku family", maxGuests: 3 },
  { id: "groom-89", name: "Fatimehin family", maxGuests: 2 },
  { id: "groom-90", name: "Imoh Iniunam", maxGuests: 1 },
  { id: "groom-91", name: "Agali family", maxGuests: 2 },
  { id: "groom-92", name: "Omo Agali", maxGuests: 1 },
  { id: "groom-93", name: "Noah Ojo", maxGuests: 1 },
  { id: "groom-94", name: "Williams family", maxGuests: 4 },
  { id: "groom-95", name: "Bro Victor Ado", maxGuests: 1 },
  { id: "groom-96", name: "Bro Otome Opuoro", maxGuests: 1 },
  { id: "groom-97", name: "Dami Folarin", maxGuests: 1 },
  { id: "groom-98", name: "Chinedum Odii", maxGuests: 1 },
  { id: "groom-99", name: "Chidinma Afogu", maxGuests: 1 },
  { id: "groom-100", name: "Aliyu Abdullahi", maxGuests: 1 },
  { id: "groom-101", name: "Emmanuel Sam", maxGuests: 1 },
  { id: "groom-102", name: "Waliyah Okunade", maxGuests: 1 },
  { id: "groom-103", name: "Adesoji Olaitan", maxGuests: 2 },
  { id: "groom-104", name: "Brown Memoye", maxGuests: 1 },
  { id: "groom-105", name: "Taiwo Raji", maxGuests: 1 },
  { id: "groom-106", name: "Precious Iwuala", maxGuests: 1 },
  { id: "groom-107", name: "Zino Ove", maxGuests: 1 },
  { id: "groom-108", name: "Edwards Ugochukwu", maxGuests: 1 },
  { id: "groom-109", name: "Nathan Ojo and family", maxGuests: 4 },
  { id: "groom-110", name: "Ojo family", maxGuests: 2 },
  { id: "groom-111", name: "Ese Eruwahvwe", maxGuests: 1 },
  { id: "groom-112", name: "Amarachi Umezurike", maxGuests: 1 },
];
