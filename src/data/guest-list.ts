...
export const guestList: GuestInvitation[] = [
  ...
  { id: "groom-96", name: "Ese Eruvwahwe", maxGuests: 1 },
  { id: "groom-97", name: "Amarachi Umezurike", maxGuests: 1 },
  { id: "groom-98", name: "Godwin Iboku", maxGuests: 2 },
  { id: "groom-99", name: "Joshua Aderinoye", maxGuests: 2 },
  { id: "groom-100", name: "Timothy Nwamu", maxGuests: 2 },
  { id: "groom-101", name: "George Akinlolu", maxGuests: 2 },
  { id: "groom-102", name: "Ahmadu Garba", maxGuests: 2 },
  { id: "groom-103", name: "Gregory Ibeh", maxGuests: 2 },
  { id: "groom-104", name: "Godswill Erokaire", maxGuests: 2 },
  { id: "groom-105", name: "Mrs Bunmi Kuku", maxGuests: 1 },
  { id: "groom-106", name: "Uncle Effiong Asuquo", maxGuests: 1 },
  { id: "groom-107", name: "Katey Bassey", maxGuests: 1 },
  { id: "groom-108", name: "Daretimbuk Essien", maxGuests: 1 },
];
