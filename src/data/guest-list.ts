...
export const guestList: GuestInvitation[] = [
  ...
  { id: "bride-37", name: "Mr David Adebayo, Mama and Baba Amuda", maxGuests: 3 },
  ...
  //groom's guests
  { id: "groom-57", name: "Oyeyemi's Family", maxGuests: 3 },
  { id: "groom-58", name: "Afolabi's Family", maxGuests: 3 },
  ...
  { id: "groom-63", name: "Eruwahvwe family", maxGuests: 6 },
  ...
  { id: "groom-78", name: "Ojo", maxGuests: 6 },
  { id: "groom-79", name: "Williams family", maxGuests: 4 },
  { id: "groom-80", name: "Bro Ado", maxGuests: 1 },
